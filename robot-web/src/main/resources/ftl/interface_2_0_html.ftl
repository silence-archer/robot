        ...
        <form class="layui-form" id="testSys" lay-filter="testSys">
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <input type="text" name="SOURCE_TYPE" id="SOURCE_TYPE" lay-verify="required"
                ...
                <div class="layui-inline">
                    ...
                    <input type="text" name="BRANCH_ID" id="BRANCH_ID" lay-verify="required"
                ...
                <div class="layui-inline">
                    ...
                    <input type="text" name="TRAN_DATE" id="TRAN_DATE" lay-verify="required"
