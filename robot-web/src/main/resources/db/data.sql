...
-- ----------------------------
INSERT INTO `t_cron_task` VALUES ('e66377ba2c724627895ead05ebcbb925', 'SignatureAccessToken', '0/5 * * * * ?', '定时获取公众号的全局唯一接口调用凭据', 'subscribeAccessTokenJob', 'N', null, '2019-12-27', null, '2019-12-30');
